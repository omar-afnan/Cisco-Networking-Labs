...
- **Layer 2:** switch-to-switch links, broadcast domains, MAC learning
- **Layer 3:** static IPv4 addressing, subnet masks, default gateways
- **Troubleshooting:** `ping`, `ipconfig`, `arp -a`, Packet Tracer Simulation mode
